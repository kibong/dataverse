...
@register_etl
def data_save___jsonl___ufl2jsonl(
    spark: SparkSession,
    ...
    **kwargs,
    ...
    """
    Save data to JSONL and return the path.
    Args:
    ...
    Returns:
        str: The path where the JSONL file is saved.
    """
    ...
    # Spark's JSON writer doesn't directly support JSONL, but saving as JSON with one file per partition
    # effectively creates a JSONL format if the DataFrame doesn't contain multiline strings.
    ufl.write.json(save_path, mode="overwrite")
